...
if __name__ == "__main__":
    ...
    subgraphs = top_k_overlapping_densest_subgraphs(
        G, k, lambda_param, min_subset_size, max_subset_size, k_hop
    )
    ...
    plot_save_subgraphs(
        G, subgraphs, k, lambda_param, min_subset_size, max_subset_size, k_hop, path
    )

    # Plot the hypergraph
    plot_save_hypergraph(
        hyper_dic, k, lambda_param, min_subset_size, max_subset_size, k_hop, path
    )
